...
```
The teams that we want to look at are below the 25th percentile and above the 75th percentile. This will help us arbitrarily label and contrast "good" vs. "bad" performance. So now we filter the data to keep only those teams.
...
Now we're down to 16 teams. We label them as "top" teams or "bottom" teams.
...
On second thought, it's really hard to objectively describe the dispersion of data points using just a boxplot. Instead, we can find the standard deviation for each group.
- [move this somewhere higher] -
...
##### Q2:
- look at bar graphs with values inside to see how correlations behave within teams
- 
