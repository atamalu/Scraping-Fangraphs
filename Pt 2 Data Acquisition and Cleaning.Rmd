...
```
Now let's write a function that retrieves a table using any url parameters we might want. In this case, we can use piping from the `dplyr` package to make the code more readable.
```{r}
